...
bitbucket_repo = f"https://{BITBUCKET_USER}:{BITBUCKET_PASSWORD}@bitbucket.org/{BITBUCKET_USER}/repo1.git"
github_repo = f"https://{GITHUB_USER}:{GITHUB_TOKEN}@github.com/{GITHUB_USER}/Migration-repo1.git"
